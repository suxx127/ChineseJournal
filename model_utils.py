            ...
            if hasattr(module, 'lora_B') and module.lora_B is not None:
                ...
                def make_hook(column_idx, row_idx):
                    def hook(grad):
                        ...
                        return grad
                    return hook
                lora_B_weight.register_hook(make_hook(frozen_column_index, frozen_row_index))
    return peft_model
